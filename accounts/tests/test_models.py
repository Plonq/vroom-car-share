...
address = Address(address_line_1='Address Line 1', address_line_2='Address Line 2', city='City', state='VIC', postcode='3000')
...
class AccountsUserModelTests(TestCase):
    ...
    def test_email_user(self):
        user.email_user('Subject', 'Message', 'testrunner@test.com')
...
class AccountsAddressModelTests(TestCase):
    def test_string_output(self):
        self.assertEqual(address.__str__(), 'Address Line 1, City, VIC 3000')


class AccountsCreditCardModelTests(TestCase):
    def test_string_output(self):
        self.assertEqual(credit_card.__str__(), 'XXXX XXXX XXXX 4444')